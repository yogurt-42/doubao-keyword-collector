...
> 本地优先的非官方 AI 关键词调研工具（首发豆包，已扩展 DeepSeek）。
> 批量向 AI 平台发送关键词，自动展开参考资料、提取链接与平台信息，存入本地 SQLite，支持筛选、导出 Excel、信源对比、长尾分析与定时任务。
...
2. 写入关键词并点击发送。
3. 等待本次回答完成。
4. 展开“搜索 X 个关键词、参考 X 篇”或 DeepSeek 的“搜索到 X 个网页”，并展开全部“展开更多”。
